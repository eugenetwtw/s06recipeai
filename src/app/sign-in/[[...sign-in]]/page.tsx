      ...
      <div className="bg-white p-8 shadow-lg rounded-xl max-w-md w-full">
        ...
        {signedOut && (
          <div className="bg-blue-50 text-blue-700 p-4 rounded-lg mb-6 text-sm">
            <div className="flex items-start">
              ...
              <div>
                <p className="font-medium">You have been signed out from the demo account.</p>
                <p className="mt-1">To continue using Recipe AI, please sign in with your own account or create a new one.</p>
              </div>
            </div>
          </div>
        )}
        ...
        <div className="flex flex-col space-y-4 mb-4">
          ...
          >
            ...
            {signedOut ? 'Demo Account Unavailable' : 'Try Demo Account'}
          </button>
        </div>
